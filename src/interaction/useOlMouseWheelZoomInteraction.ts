...
import { OlMouseWheelZoomInteractionEvents } from '@src/interaction/event';
...
export const useOlMouseWheelZoomInteraction = (
  options?: OlMouseWheelZoomInteractionOptions,
  observable?: OlMouseWheelZoomInteractionEvents<MouseWheelZoom>,
  active = true,
) => {
