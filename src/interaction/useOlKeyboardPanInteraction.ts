...
import { OlKeyboardPanInteractionEvents } from '@src/interaction/event';
...
export const useOlKeyboardPanInteraction = (
  options?: OlKeyboardPanInteractionOptions,
  observable?: OlKeyboardPanInteractionEvents<KeyboardPan>,
  active = true,
) => {
