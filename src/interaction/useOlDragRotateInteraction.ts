...
import { OlDragRotateInteractionEvents } from '@src/interaction/event';
...
export const useOlDragRotateInteraction = (
  options?: OlDragRotateInteractionOptions,
  observable?: OlDragRotateInteractionEvents<DragRotate>,
  active = true,
) => {
