...
import { OlDblClickDragZoomInteractionEvents } from '@src/interaction/event';
...
export const useOlDblClickDragZoomInteraction = (
  options?: OlDblClickDragZoomInteractionOptions,
  observable?: OlDblClickDragZoomInteractionEvents<DblClickDragZoom>,
  active = true,
) => {
